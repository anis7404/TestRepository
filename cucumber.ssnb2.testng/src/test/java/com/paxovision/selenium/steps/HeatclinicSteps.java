...
import com.paxovision.selenium.heatclinic.HomePage;
import com.paxovision.selenium.heatclinic.LoginPage;
...
public class HeatclinicSteps {
	...
	public void invalid_email_or_password_message_display(String msg) throws Throwable {
		 String text = driver.findElement(By.cssSelector("span.error")).getText();
		    System.out.println(text);
